#ifndef PENGUINCAFE_MATRICES_HEADERS_WRONG
#define PENGUINCAFE_MATRICES_HEADERS_WRONG

// NAO SE DEVE DEFINIR FUNÇÕES EM ARQUIVOS .H
...
#endif // PENGUINCAFE_MATRICES_HEADERS_WRONG
