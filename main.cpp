...
void BuildTrianglesAndAddToVirtualScene(
        ObjModel *); // Constrói representação de um ObjModel como malha de triângulos para renderização
...
// MANO PQ TU COLO A PORRA DO HEADER FILE NA MAO ASSIM? ????
// DIZ PRO PC FAZER AS COOISA INVES DE FAZER NA MAO
// TU SABE PROGRAMA VIADO?

#include "rendering/text.hpp"
#include "globals/variables.hpp"
...
int main(int argc, char *argv[]) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::vec4 camera_lookat_l = glm::vec4(0.0f, 0.0f, 0.0f,
        ...
        glm::vec4 camera_up_vector = glm::vec4(0.0f, 1.0f, 0.0f,
...
void LoadShadersFromFiles() {
    ...
    projection_uniform = glGetUniformLocation(program_id,
